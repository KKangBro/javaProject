...
/*
* 1. 변수: data를 저장하기 위한 기억장소이름, 값 수정 가능 2. 상수: data를 저장하기 위한 기억장소이름, 값 수정 불가능 3.
* enum: 상수 묶음 4. method: 문장들을 묶음 5. class: object를 만드는 틀. 변수+상수+메서드 6. object:
* class로 new한 실체 7. interface: 규격서. 상수+추상메서드+(default메서드+static메서드)
*/
